...
class GenerateQuestionsRequest(BaseModel):
    goal: str = Field(..., description="Goal of the questions (e.g., 'GATE AE', 'Amazon SDE')", example="GATE AE", enum=["GATE AE", "Amazon SDE", "CAT", "MAT"])
...
class ConfigResponse(BaseModel):
    ...
    type: list = Field(..., description="Type of the questions", example=["mcq", "short_answer"])
